...
@book_router.get(path='/', status_code=status.HTTP_200_OK, response_model=list[Book])
...
@book_router.patch(path='/update_book/{id}', status_code=status.HTTP_200_OK, response_model=BookUpdate)
